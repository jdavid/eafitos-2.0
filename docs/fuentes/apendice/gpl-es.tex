...
\bigskip
\centerline{{\bf LICENCIA PÚBLICA GENERAL DE GNU}}
\centerline{Versión 2, Junio de 1991
\footnote{Traduccida al catellano por Jes\'{u}s M. González, 
...
\section[Términos y condiciones]{Términos y condiciones para la copia,
...
cualquier porción de él, formando de esta manera un trabajo basado
...
\begin{enumerate}
  \item[a.] Acompañarlo con el código fuente completo
  ...
  \item[b.] Acompañarlo con una oferta por escrito, válida
  ...
  \item[c.] Acompañarlo con la información que recibiste
...
\item[5.] No está obligado a aceptar esta licencia, ya que no la
...
\item[7.] Si como consecuencia de una resolución judicial o
...
\item[8.] Si la distribución y/o uso de el Programa está
...
OFRECE NINGUNA GARANTÍA SOBRE EL PROGRAMA, EN TODA LA EXTENSIÓN
...
\item[12.] EN NINGÚN CASO, SALVO QUE LO REQUIERA LA LEGISLACIÓN
...
\section[Cómo aplicar estos términs]{Cómo aplicar estos términos a sus
	nuevos programas}
...
\begin{quote}
	\cparam{una línea para indicar el nombre del programa y una
	rápida idea de qué hace.}
	Copyright (C) 19aa  \cparam{nombre del autor}

	Este programa es software libre. Puede redistribuirlo y/o
	modificarlo bajo los términos de la Licencia Pública General
	de GNU según es publicada por la Free Software Foundation, bien
	de la versión 2 de dicha Licencia o bien (según su elección)
...
\begin{tscreen}
  ...
  ciertas condiciones. Escriba ``show c'' para más detalles.
\end{tscreen}
